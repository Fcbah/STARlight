...
//  define histos
    ...
    TH1D* D1Eta   = new TH1D("D1Eta", "Pseudorapidity of Daughter 1",200,-10,10);
    TH1D* D1Eta2   = new TH1D("D1Eta2", "Pseudorapidity of Daughter 1 with eta function",200,-10,10);
    ...
    TH1D* D2Eta     = new TH1D("D2Eta","Pseudorapidity of Daughter 2",200, -10, 10);
    ...
    TH1D* ParentEta = new TH1D("ParentEta","Pseudorapidity of the Parent",200,-10,10);
...
// Fill histograms
   ...
   D1Eta->Fill(D1->PseudoRapidity());
   D1Eta2->Fill(D1->Eta());
   D2Eta->Fill(D2->PseudoRapidity());
   ...
   ParentEta->Fill(parent->PseudoRapidity());
